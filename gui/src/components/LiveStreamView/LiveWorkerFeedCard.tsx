...
interface LiveWorkerFeedCardProps {
  identity: string
  participant: any
  videoTrack: any
  selected: boolean
...
export default function LiveWorkerFeedCard({ identity, participant, videoTrack, selected, onClick }: LiveWorkerFeedCardProps) {
  ...
  return (
    <button
      ...
      style={{
        ...
        background: '#0C0F14', position: 'relative', cursor: 'pointer',
    ...
    >
      ...
      <div style={{ position: 'absolute', top: 6, left: 6, display: 'flex', alignItems: 'center', gap: 4, background: 'rgba(0,0,0,0.75)', padding: '2px 6px', borderRadius: 4 }}>
