...
const TRADE_WORKERS: Record<string, string[]> = {
...
function getWorkerList(zone: Zone & { workerList?: WorkerEntry[] }): WorkerEntry[] {
  if (zone.workerList) return zone.workerList
  const list: WorkerEntry[] = []
...
export default function ZoneRow({ zone, expanded, onToggle }: ZoneRowProps) {
