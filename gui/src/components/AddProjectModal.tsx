...
export default function AddProjectModal({ isOpen, onClose, onSuccess }: AddProjectModalProps) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setError((e as Error).message || 'Failed to create project. Is the backend running?')
    } finally {
      setSubmitting(false)
    }
  }
      ...
      >
        ...
        <div style={{ marginBottom: 24 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 8 }}>
            {[
              { label: 'Frames', value: '0', dot: undefined },
              { label: 'Workers', value: '0', dot: undefined },
              { label: 'Trades', value: '0', dot: undefined },
