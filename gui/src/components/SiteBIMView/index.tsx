...
import type { SiteLayout } from './siteLayouts'
...
function BuildingShell({ position, size, isSlab }: BuildingShellProps) {
  return (
...
function Scene({ layout, zones, selectedIdx, onSelect }: SceneProps) {
  return (
    <>
 ...
 */
export default function SiteBIMView({ zones, siteId, onSelectZone }: SiteBIMViewProps) {
