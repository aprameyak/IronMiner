...
interface WorkerPoolProps {
  workers: SiteWorker[]
  onWorkerClick?: ((worker: SiteWorker) => void) | null
}
 ...
 */
export default function WorkerPool({ workers, onWorkerClick }: WorkerPoolProps) {
  ...
  const byTrade = filtered.reduce<Record<string, SiteWorker[]>>((acc, w) => {
    ...
    >
      ...
      <div style={{ position: 'relative', marginBottom: 14 }}>
        ...
        <input
          ...
          onFocus={(e: React.FocusEvent<HTMLInputElement>) => e.target.style.borderColor = 'rgba(249,115,22,0.4)'}
