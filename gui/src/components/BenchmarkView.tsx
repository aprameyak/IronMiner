...
import type { Team, Benchmark, BenchmarkGoal, EvaluationResult } from '../types'
...
function PieChart({ completed, total }: PieChartProps) {
...
export default function BenchmarkView({ siteId }: BenchmarkViewProps) {
